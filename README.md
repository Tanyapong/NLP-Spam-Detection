# NLP-Spam-Detection
NLP Spam Detection with Dense, LSTM, and Bi-LSTM  for Deep learning (ITS486)
This project is for Deep learning (ITS486)
we use the SmsSpamCollection from UCI Machine learning --> https://archive.ics.uci.edu/ml/datasets/sms+spam+collection
